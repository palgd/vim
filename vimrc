...
" vim
set ts=2 sts=2 sw=2 tw=2: (この行に関しては:help modelineを参照)
"
...
colorscheme elflord " (Windows用gvim使用時はgvimrcを編集すること)
...
set migemo
let $LUA_DLL = simplify($VIM . '/../../Frameworks/libluajit-5.1.2.0.2.dylib')
